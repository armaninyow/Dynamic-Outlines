...
public final class FluidOutlineRenderer {
	...
	public static void render(WorldRenderContext context) {
		...
		VertexConsumer consumer = context.consumers().getBuffer(DynamicLineRenderType.get(cfg.strokeWidth));
		...
		poseStack.pushPose();
		OutlineRenderer.renderSolid(poseStack, consumer, Shapes.block(), dx, dy, dz, rgb[0], rgb[1], rgb[2], cfg.outlineAlpha / 100F);
		poseStack.popPose();
	}
