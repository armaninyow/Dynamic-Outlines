...
public final class RespawnAnchorTracker {
	...
	public static void load() {
		...
		lastSetDimension = ResourceKey.create(Registries.DIMENSION, ResourceLocation.fromNamespaceAndPath(namespace, path));
	}
	...
	public static void recordSpawnSet(BlockPos pos, ResourceKey<Level> dimension) {
		...
		cfg.respawnAnchorDimension = dimension.location().toString();
		ModConfig.save();
	}
