...
public class ModConfig {
	...
	public boolean showOutlineWhenPlacementBlocked = false;
	public boolean currentlyBreakingOverride = true;
	...
	public boolean blendOutlinesWithLight = true;
	public boolean outlineInvisibleMobs = false;
	...
	private static void dynamicoutlines$invalidateEntityOutlinePostChain() {
		...
		minecraft.execute(() -> {
			...
			java.util.Map<Identifier, java.util.Optional<PostChain>> postChains = cacheAccessor.dynamicoutlines$getPostChains();
			Identifier entityOutlineId = Identifier.fromNamespaceAndPath("minecraft", "entity_outline");
